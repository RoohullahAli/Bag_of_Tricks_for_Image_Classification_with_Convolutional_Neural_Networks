...
# CIFAR-100 stats (BGR order to match OpenCV pipeline)
CIFAR100_TRAIN_MEAN = [0.4408, 0.4867, 0.5071]
CIFAR100_TRAIN_STD = [0.2761, 0.2565, 0.2675]
CIFAR100_TEST_MEAN = [0.4408, 0.4867, 0.5071]
CIFAR100_TEST_STD = [0.2761, 0.2565, 0.2675]
CIFAR100_DATA_PATH = './data'
